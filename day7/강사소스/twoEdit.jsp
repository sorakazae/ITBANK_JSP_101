...
<body> 
<font size=6><b> [twoEdit.jsp=단독실행X]</b></font>
 <%
  try{
	//twoDetail.jsp문서 맨마지막 a태그
	//<a href="twoEdit.jsp?idx=2234">[편집]</a>
 ...
 %> 
	<!-- two.jsp문서 form태그복사할거에요  -->
	<!-- twoEdit.jsp문서 단독실행X, action="twoEditSave.jsp" -->
  <p>
  <form  name="myform"  action="twoEditSave.jsp">
  	<b>사번: </b>
  	  <input type=text  name="sabun"   value="<%= data1 %>"   readonly   style="font-size:20pt;"> <br>
  	<b>이름: </b>
  	  <input type=text  name="name"  value="<%= data2 %>"   style="font-size:20pt;"> <br>
  	<b>급여: </b>
  	<input type=text  name="pay"  value="<%=data3 %>"    style="font-size:20pt;" > <p>
